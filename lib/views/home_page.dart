...
import 'package:weather_app/views/detail_page.dart';
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Column(children: [
            ...
            Expanded(
                child: weatherController.weather.isEmpty
                    ? Center(
                        child: isError != true
                    ...
                    : ListView.builder(
                        itemCount: weatherController.weather.length,
                        itemBuilder: (context, index) {
                          final weather = weatherController.weather[index];
                          return Padding(
